...
<head>
    ...
    <title>Mastoura Dashboard</title>
    <link rel="icon" href="img/logo.png">
    <!--Bootstrap-->
    <link rel="stylesheet" href="/mastora/css/bootstrap.rtl.min.css">
    <!--Project Style-->
    <link rel="stylesheet" href="/mastora/css/main.css">
    <link rel="stylesheet" href="/mastora/css/style.css">
    <!--fontAwesome-->
...
<body>
        ...
        <div class="row d-flex justify-content-center" style="margin: auto;">
          <div class="col-6">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-container">
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 mb-4">
                          ...
                          <input class="text-start" name="email" placeholder="البريد الالكتروني" type="email">
                        </div>
                ...
                <div class="row form-action mt-4 d-flex justify-content-end">
                  <div class="col-6">
    ...
    <script src="/mastora/js/popper.min.js"></script>
    <script src="/mastora/js/bootstrap.min.js"></script>
    <script src="/mastora/js/main.js"></script>
</body>
</html
