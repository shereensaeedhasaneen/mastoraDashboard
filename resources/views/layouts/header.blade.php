...
<head>
    ...
    <!--Bootstrap-->
    <link rel="stylesheet" href="{{asset("mastora/css/bootstrap.rtl.min.css")}}">
    <!--Project Style-->
    <link rel="stylesheet" href="{{asset("mastora/css/all.min.css")}}">
    <link rel="stylesheet" href="{{asset("mastora/css/main-forms.css")}}">
    <link rel="stylesheet" href="{{asset("mastora/css/main.css")}}">
    <link rel="stylesheet" href="{{asset("mastora/css/style.css")}}">
    <link rel="stylesheet" href="{{asset("mastora/css/dataTables.bootstrap5.min.css")}}">
    <link rel="stylesheet" href="{{asset("mastora/css/toastAlert.css")}}">

    <!--fontAwesome-->
    {{-- <script src="https://kit.fontawesome.com/2e646d6873.js" crossorigin="anonymous"></script> --}}
    <script src="{{asset("mastora/js/fontAwesome.js")}}"></script>
    <!-- Google Font -->
    ...
    <link rel="stylesheet" href="{{asset("mastora/css/nice-select.css")}}">
</head>

<body>

    <nav class="navbar d-flex flex-column navbar-expand-lg navbar-light pb-0">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="208.729" height="71.869" viewBox="0 0 208.729 71.869">
                <defs>
            ...
            <div class="d-flex notification">
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="/logout"> <i class="fas fa-power-off"></i> خروج</a></li>
                  </ul>
                </div>
                <div class="user-photo">
                    <img src="{{asset('mastora/img/navbarAvatar.png')}}">
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row w-100">
                <div class="col-9 ps-3 offset-3">
                    <h3 class="mb-0 header-title d-flex">لوحة تحكم @lang('main.user_type_' . auth()->user()->user_type)

                        <p class="mb-0 d-flex align-items-end">( فرع {{auth()->user()->bank->name}})</p>
                    </h3>
                </div>
            </div>
        </div>
